...
use Binaerpiloten\MagicBundle\Entity\Edition;
use Binaerpiloten\MagicBundle\Form\EditionType;
...
class EditionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BinaerpilotenMagicBundle:Edition')->findAll();
     ...
     * @Method("POST")
     * @Template("BinaerpilotenMagicBundle:Edition:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BinaerpilotenMagicBundle:Edition')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("BinaerpilotenMagicBundle:Edition:edit.html.twig")
     */
